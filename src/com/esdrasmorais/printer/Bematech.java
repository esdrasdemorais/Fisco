...
public class Bematech {
	...
	public static native int AbreComprovanteNaoFiscalVinculadoCV0909(int formaPagamento, String indiceFormaPagamento,
			int quantidadePagamento, int numeroPagamento, String cPF, String cNome, String endereco);
	...
	public static native int AbreBilhetePassagem(String imprimeValorFim, String imprimeEnfatizado, String embarque,
			String destino, String linha, String prefixo, String agente, String agencia, String data, String hora,
			String poltrona, String plataforma);
	...
	public static native int EfetuaFormaPagamentoDescricaoForma(String formaPagamento, String valorFormaPagamento,
	...
	public static native int EstornoFormasPagamentoCV0909(String formaOrigem, String formaDestino, String valor,
			int destinoPagamentoSequencia, String mensagem);

	public static native int FechaCupom(String formaPagamento, String acrescimoDesconto, String tipoAcrescimoDesconto,
	...
	public static native int IniciaFechamentoCupom(String acrescimoDesconto, String tipoAcrescimoDesconto,
	...
	public static native int ProgramaAliquotasEspeciais(String aliquotaF, String aliquotaI, String aliquotaN,
			String aliquotaFS, String aliquotaIS, String aliquotaNS);
	...
	public static native int VendeItem(String codigo, String descricao, String aliquota, String tipoQuantidade,
			String quantidade, int casasDecimais, String unitario, String tipoDesconto, String desconto);

	public static native int VendeItemCV0909(String codigo, String descricao, String aliquota, String quantidade,
			int casasDecimais, String unitario, String unidadeMedida, String valorUnitarioDecimal,
			String tipoDeCalculo);

	public static native int VendeItemDetalhadoCV0909(String code, String description, String tax, String unitOfMeasure,
			String quantity, String decimalsQuantity, String unitaryValue, String decimalUnitaryValue,
			String typeOfCalculation, String EAN13, String NCM, String CFOP, String additionalInformation,
			String productOrigin, String CST_ICMS, String simplesCode, String IBGECityCode, String itemServiceList,
			String ISSCode, String ISSOperationNature, String ISSIncentiveIndicator);

	public static native int VendeItemCompleto(String code, String EAN13, String description, String indexDepartment,
			String tax, String unitOfMeasure, String quantityType, String decimalsQuantity, String quantity,
			String decimalsUnitaryValue, String unitaryValue, String increaseDiscountType, String incrementValue,
			String discountValue, String typeOfCalculation, String NCM, String CFOP, String additionalInformation,
			String CST_ICMS, String productOrigin, String itemServiceList, String ISSCode, String ISSOperationNature,
			String ISSIncentiveIndicator, String IBGECode, String CSOSN, String basisCalculuationValue,
			String ICMSValueRetained, String reserved01, String reserved02, String reserved03, String reserved04,
			String reserved05, String reserved06, String reserved07, String reserved08, String reserved09,
			String reserved10, String reserved11, String reserved12, String reserved13, String reserved14,
			String reserved15, String reserved16, String reserved17, String reserved18, String reserved19,
			String reserved20, String reserved21, String reserved22, String reserved23, String reserved24,
			String reserved25, String reserved26, String reserved27, String reserved28, String reserved29,
			String reserved30, String reserved31, String reserved32, String reserved33, String reserved34,
			String reserved35);

	public static native int VendeItemDepartamento(String codigo, String descricao, String aliquota,
			String valorUnitario, String cQuantidade, String valorAcrescimo, String valorDesconto,
			String indiceDepartamento, String cUnidadeMedida);
	...
	public static native int RetornoImpressoraCV0909(BemaInteger CAT, BemaInteger RET1,
			BemaInteger RET2, BemaInteger RET3, BemaInteger RET4);
	...
	public static native int RecebimentoNaoFiscal(String indiceTotalizador, String valorRecebimento,
	...
	public static native int ImprimeCheque(String numeroBanco, String valor, String favorecido, String cidade,
			String data, String mensagem);
	...
	public static native int VerificaEstadoImpressora(BemaInteger ACK, BemaInteger ST1,
			BemaInteger ST2);
	...
	public static native int AbreBilhetePassagemMFD(String embarque, String destino, String cLinha, String agencia,
			String data, String cHora, String cPoltrona, String cPlataforma, String tipoPassagem, String cRG,
			String cNome, String endereco, String cUF);

	public static native int AbreComprovanteNaoFiscalVinculadoMFD(String formaPagamento, String valor,
			String numeroCupom, String cPF, String cNome, String endereco);
	...
	public static native int AcrescimoDescontoItemMFD(String item, String acrescimoDesconto,
			String tipoAcrescimoDesconto, String valorAcrescimoDesconto);

	public static native int AcrescimoDescontoItemCV0909(String item, String acrescimoDesconto,
			String tipoAcrescimoDesconto, String valorAcrescimoDesconto);
	...
	public static native int AcrescimoDescontoSubtotalCV0909(String flag, String tipo, String valor);
	...
	public static native int ConfiguraCodigoBarrasMFD(int altura, int largura, int posicaoCaracteres, int fonte,
			int margem);
	...
	public static native int DownloadMFD(String nomeArquivo, String tipoDownload, String dadoInicial, String dadoFinal,
			String usuario);

	public static native int DownloadMFDCV0909(String nomeArquivo, String tipoDownload, String dadoInicial,
			String dadoFinal);
	...
	public static native int EfetuaFormaPagamentoMFD(String formaPagamento, String valorFormaPagamento,
			String cParcelas, String descricaoFormaPagto);

	public static native int EfetuaFormaPagamentoIndiceMFD(String indice, String valorFormaPagamento, String cParcelas,
			String descricaoForma);

	public static native int EfetuaFormaPagamentoIndiceCV0909(String indice, String valorFormaPagamento,
			String cParcelas, String descricaoForma);
	...
	public static native int ImprimeChequeMFD(String numeroBanco, String valor, String favorecido, String cidade,
			String data, String msg, String impressaoVerso, String cLinhas);

	public static native int IniciaFechamentoCupomMFD(String acrescimoDesconto, String tipoAcrescimoDesconto,
			String valorAcrescimo, String valorDesconto);

	public static native int IniciaFechamentoRecebimentoNaoFiscalMFD(String acrescimoDesconto,
			String tipoAcrescimoDesconto, String valorAcrescimo, String valorDesconto);
	...
	public static native int LeituraMemoriaFiscalReducaoMFD(String cReducaoInicial, String cReducaoFinal,
			String flagLeitura);

	public static native int LeituraMemoriaFiscalReducaoCV0909(String cReducaoInicial, String cReducaoFinal,
			String flagLeitura);

	public static native int LeituraMemoriaFiscalSerialDataMFD(String dataInicial, String dataFinal,
			String flagLeitura);

	public static native int LeituraMemoriaFiscalSerialDataCV0909(String dataInicial, String dataFinal,
			String flagLeitura);

	public static native int LeituraMemoriaFiscalSerialReducaoMFD(String cReducaoInicial, String cReducaoFinal,
			String flagLeitura);

	public static native int LeituraMemoriaFiscalSerialReducaoCV0909(String cReducaoInicial, String cReducaoFinal,
			String flagLeitura);

	public static native int MapaResumoMFD();

	public static native int MarcaModeloTipoImpressoraMFD(BemaString marca, BemaString modelo,
			BemaString tipo);
	...
	public static native int ProgramaFormaPagamentoCV0909(String indicePagamento, String formaPagamento,
			int cCDVinculado);
	...
	public static native int RetornoImpressoraMFD(BemaInteger ACK, BemaInteger ST1, BemaInteger ST2,
			BemaInteger ST3);
	...
	public static native int PreparaAbreCupom(BemaString cupom, BemaString contadorCupom,
			BemaInteger flag, BemaString data, BemaString hora, BemaString numeroSerie,
			BemaString grandeTotal);
	...
	public static native int RetornaChavePublica(BemaString softwareBasico, BemaString arquivosEletronicos,
			BemaString arquivosEmitidos, BemaString acessoRemoto, BemaString MIL_MIT);
	...
	public static native int StatusMovimento(BemaString dataMovim, BemaInteger status,
			BemaString COOInicial, BemaString gradeInicialTotal);

	public static native int FormatoDadosMF(String origem, String destino, String formato, String tipoLeitura,
			String tipoParametro, String dadoInicial, String dadoFinal);

	public static native int FormatoDadosMFD(String arquivoMFD, String destino, String formato, String tipoDownload,
			String dadoInicial, String dadoFinal, String cUsuario);

	public static native int GeraRelatorioSintegraMFD(int iRelatorios, String cOrigem, String destino, String mes,
			String ano, String cRazaoSocial, String endereco, String numero, String complemento, String cBairro,
			String cidade, String CEP, String telefone, String fax, String contato);
	...
	public static native int RelatorioSintegraMFD(int relatorios, String arquivo, String mes, String ano,
			String razaoSocial, String endereco, String numero, String complemento, String bairro, String cidade,
			String CEP, String telefone, String fax, String contato);

	public static native int GeraRegistrosSpedMFD(String arquivoOrigem, String arquivoDestino, String dataInicial,
			String dataFinal, String perfil, String cfop, String cobs, String pis, String cofins);

	public static native int GeraRegistrosSpedCompleto(String arquivoOrigem, String arquivoDestino, String dataInicial,
			String dataFinal, String perfil, String cfop, String cobs, String pis, String cofins, String companyName,
			String IBGECode);

	public static native int TerminaFechamentoCupomCodigoBarrasMFD(String mensagem, String tipoCodigo, String codigo,
			int iAltura, int iLargura, int iPosicaoCaracteres, int iFonte, int iMargem, int iCorrecaoErros,
			int iColunas);
	...
	public static native int AcrescimoItemNaoFiscalMFD(String numeroItem, String acrDesc, String tipoAcrDesc,
			String valorAcrDesc);
	...
	public static native int VerificaEstadoImpressoraMFD(BemaInteger ACK, BemaInteger ST1,
			BemaInteger ST2, BemaInteger ST3);
	...
	public static native void CriptografaDescriptografa(String buffer, int tamanhoBuffer, String chave,
			int tamanhoChave);
	...
	public static native int NumeroSerieDescriptografado(String NumSerieCriptografado,
			BemaString NumSerieDescriptografado);

	public static native int EfetuaFormaPagamentoIndiceDescricaoForma(String IndiceFormaPagamento,
			String ValorFormaPagamento, String DescricaoForma);
	...
	public static native int ImprimeChequeMFDEx(String NumeroBanco, String Valor, String Favorecido, String Cidade,
			String Data, String Mensagem, String Fonte);

	public static native int EstornoNaoFiscalVinculadoPosteriorMFD(String FromaPagamento, String Valor, String COOCupom,
			String COOCDC, String CPF, String Nome, String Endereco);
	...
	public static native int VendeItemArredondamentoMFD(String Codigo, String Descricao, String Aliquota,
			String UnidadeMedida, String QtdFracionaria, String Unitario, String Acrescimo, String Desconto,
			boolean Arredonda);

	public static native int FlagsFiscais3MFD(BemaInteger flag);

	public static native int DataHoraGravacaoUsuarioSWBasicoMFAdicional(BemaString DataUsuario,
			BemaString DataSoftwareBasico, BemaString letraAdicional);
	...
	public static native int AbreDocumentoAuxiliarVenda(String cIndice, String cTitulo, String cNumeroDAV,
			String cNomeEmitente, String cCNPJ_CPFEmitente, String cNomeDestinatario, String CNPJ_CPFDestinatario);
	...
	public static native int TerminaFechamentoCupomPreVenda(String cMD5, String cNumeroPreVenda,
			String cMensagemPromocional);

	public static native int DAVEmitidosRelatorioGerencial(String cIndice, String cDataInicial, String cDataFinal);

	public static native int DAVEmitidosArquivo(String cNomeArquivo, String cDataInicial, String cDataFinal,
			String cChavePublica, String cChavePrivada);

	public static native int LeituraMemoriaFiscalSerialDataPAFECF(String cDataInicial, String cDataFinal,
			String cFlagLeitura, String cChavePublica, String cChavePrivada);

	public static native int LeituraMemoriaFiscalSerialReducaoPAFECF(String cCRZInicial, String cCRZFinal,
			String cFlagLeitura, String cChavePublica, String cChavePrivada);

	public static native int EspelhoMFD(String cNomeArquivoDestino, String cDadoInicial, String cDadoFinal,
			String cTipoDownload, String cUsuario, String cChavePublica, String cChavePrivada);

	public static native int ArquivoMFD(String cNomeArquivoOrigem, String cDadoInicial, String cDadoFinal,
			String cTipoDownload, String cUsuario, int cParametrizacao, String cChavePublica, String cChavePrivada,
			int iArquivoUnico);

	public static native int ArquivoMFDPath(String cNomeArquivoOrigem, String nomeArquivoDestino, String cDadoInicial,
			String cDadoFinal, String cTipoDownload, String cUsuario, int cParametrizacao, String cChavePublica,
			String cChavePrivada, int iArquivoUnico);

	public static native int IdentificacaoPAFECF(String cIndice, String cNumeroLaudo, String cCNPJDesenvolvedor,
			String cRazaoSocial, String cEndereco, String cTelefone, String cContato, String cNomeComercial,
			String cVersao, String cPrincipalExecutavel, String cMD5PrincipalExecutavel, String cDemaisArquivos,
			String cMD5DemaisArquivos, String cNumerosFabricacao);
	...
	public static native int UsaRelatorioMeiosPagamento(String cIdentificacao, String cTipoDocumento,
			String cValorAcumulado, String cData);
	...
	public static native int DadosConsumidorNFCe(String cpf, String name, String address, String complement,
			String number, String neighborhood, String IBGECode, String city, String UF, String CEP, String countryCode,
			String country, String phone, String stateRegistrationIndicator, String stateRegistration,
			String SUFRAMACode, String email);
	...
	public static native int UltimasInformacoesSAT(BemaString accessKey, BemaString billNumber,
			BemaString satNumber);

	public static native int RetornaMensagemSefaz(BemaString message, BemaString code,
			BemaString errorMessage, BemaString errorCode);
